// Importamos el objeto 'db' que contiene los modelos y constantes definidas en la aplicación
import db from "../models/index.js";

// Extraemos las constantes ROLES y el modelo User del objeto db
...
export const checkDuplicateUsernameOrEmail = async (req, res, next) => {
  try {
    ...
    // Si se encuentra un usuario con ese nombre, respondemos con un error
    if (userByUsername) {
